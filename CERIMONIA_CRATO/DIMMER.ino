...
void atribui_dimmer() {
  ...
  if (counter == 10) {
    for (byte i = 0; i < canais_dim; i++) {
      ...
      pieces[i] = map(pieces[i], 0, 100, 128, 0);
      powers[i] = pieces[i];
