...
class DMXConnection(object):
  def __init__(self, comport = "COM6"):
    ...
    try:
      ...
      print ("Could not open device {}. Quitting application.".format( com_name))
      sys.exit(0)

    print ("Opened {}.".format(self.com.portstr))
  ...
  def render(self):
    ...
    # print((''.join(packet)).decode('utf-8'))
    self.com.write(''.join(packet).encode())
